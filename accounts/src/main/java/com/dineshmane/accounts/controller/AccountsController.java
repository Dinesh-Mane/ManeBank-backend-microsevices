...
import com.dineshmane.accounts.dto.ErrorResponseDto;
...
@Validated
@Tag(
        name = "CRUD REST APIs for Accounts in ManeBank",
        description = "CRUD REST APIs in ManeBank to CREATE, FETCH, AND DELETE Account details"
)
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to register a new Customer and create a new Account inside ManeBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
